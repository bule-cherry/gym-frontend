        ...
        children: [
            {
                path: '/dashboard',
                component: () =>
                    import('@/layout/dashboard/Index.vue'),
                name: 'dashboard',
                meta: {
                    title: '首页',
                    icon: '#icondashboard'
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: "/roleList",
                component: () =>
                    import('@/views/system/RoleList.vue'),
                name: "roleList",
                meta: {
                    title: "角色管理",
            ...
            },
            {
                path: "/menuList",
                component: () =>
                    import('@/views/system/MenuList.vue'),
                name: "menuList",
                meta: {
                    title: "权限管理",
        ...
        children: [
            {
                path: "/cardType",
                component: () =>
                    import('@/views/member/CardType.vue'),
                name: "cardType",
                meta: {
                    title: "会员卡类型",
                    icon: "UserFilled",
            ...
            },
            {
                path: "/memberList",
                component: () =>
                    import('@/views/member/MemberList.vue'),
                name: "memberList",
                meta: {
                    title: "会员管理",
                    icon: "Wallet",
