        ...
        <el-row>
          <el-col :span="12" :offset="0">
            <el-form-item prop="birthday" label="生日">
              <el-date-picker style="width:100%" v-model="addModel.birthday" type="date" placeholder="请选择生日"
                size="default" value-format="YYYY-MM-DD" format="YYYY-MM-DD" />
            </el-form-item>
          </el-col>
          <el-col :span="12" :offset="0">
            <el-form-item prop="joinTime" label="加入时间">
              <el-date-picker style="width:100%" v-model="addModel.joinTime" type="date" placeholder="请选择加入时间"
        ...
        <el-row>
          ...
          <el-col :span="12" :offset="0">
            <el-form-item prop="roleId" label="角色">
              <el-select style="width:100%" v-model="addModel.roleId" class="m-2" placeholder="请选择角色" size="default">
