    ...
    <el-main>
        ...
        <el-form :model="listParm" :inline="true" size="default">
            ...
            <el-form-item>
                ...
                <el-button v-permission="['sys:memberRoot:add']" :icon="Plus" type="primary"
        ...
        <el-table :height="tableHeight" :data="tableList.list" border stripe>
            ...
            <el-table-column label="操作" align="center" width="220">
                <template #default="scope">
                    <el-button v-permission="['sys:memberRoot:edit']" type="primary" :icon="Edit" size="default"
                        @click="editBtn(scope.row)">编辑</el-button>
                    <el-button v-permission="['sys:memberRoot:delete']" type="danger" :icon="Delete" size="default"
...
//表格操作
const { listParm, getList, resetBtn,
    searchBtn, tableList, sizeChange, currentChange, tableHeight, refresh
} = useMemberTable();
//新增、编辑
