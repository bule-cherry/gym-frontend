<template>
    <el-main style="padding-top: 10px">
        ...
        <div style="display: flex; align-items: center;">
            <el-button style="margin-bottom: 10px" type="primary" :icon="Plus" size="default"
                @click="addBtn">新增</el-button>
        </div>
        <!-- 表格数据 -->
        <el-table :height="tableHeight" :data="tableList.list" row-key="menuId" :tree-props="{
            ...
            <el-table-column prop="type" label="类型">
                <template #default="scope">
                    <el-tag v-if="scope.row.type == '0'" size="default">目
                        录</el-tag>
...
//表格数据
const { tableList, tableHeight, refresh, getList } =
    useMenuTable();
//新增、编辑
